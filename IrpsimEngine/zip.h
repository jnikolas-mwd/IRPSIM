...
HZIP CreateZip(const wchar_t *fn, const char *password);
...
ZRESULT ZipAdd(HZIP hz, const wchar_t *dstzn, const wchar_t *fn);
ZRESULT ZipAdd(HZIP hz, const wchar_t *dstzn, void *src, unsigned int len);
ZRESULT ZipAddHandle(HZIP hz, const wchar_t *dstzn, HANDLE h);
ZRESULT ZipAddHandle(HZIP hz, const wchar_t *dstzn, HANDLE h, unsigned int len);
ZRESULT ZipAddFolder(HZIP hz, const wchar_t *dstzn);
...
unsigned int FormatZipMessage(ZRESULT code, wchar_t *buf,unsigned int len);
